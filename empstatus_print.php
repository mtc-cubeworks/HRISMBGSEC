...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "empstatus_print";
...
$page_layouts["empstatus_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "empstatus" );
