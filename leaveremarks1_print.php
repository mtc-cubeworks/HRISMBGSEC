...
require_once("include/leaveremarks1_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "leaveremarks1_print";
...
$page_layouts["leaveremarks1_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "leaveremarks1" );
