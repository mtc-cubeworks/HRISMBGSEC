...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "standardsetup_print";
...
$page_layouts["standardsetup_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "standardsetup" );
