...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "notestatuses_print";
...
$page_layouts["notestatuses_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "notestatuses" );
