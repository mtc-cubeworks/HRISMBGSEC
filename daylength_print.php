...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "daylength_print";
...
$page_layouts["daylength_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "daylength" );
