...
$pdf->Cell(0,5,'SSS No: '.$qh['EmployerSSSNo'],0,1,'L');
$pdf->SetFont('Arial','',10);
$pdf->Cell(0,5,'Address: '.$qh['EmployerAddress'],0,1,'L');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(0,5,'SUMMARY OF SSS CONTRIBUTION',0,1,'L');
$pdf->SetFont('Arial','',10);
...
$pdf->Cell(72	,7,'EMPLOYEE NAME',0,0, 'L');
$pdf->Cell(29	,7,'SSS NO.',0,0,'L');
...
$pdf->Cell(26,4,$invoice['SSSNo'],0,0,'L');
$pdf->Cell(18,4,number_format($invoice['SSS'],2),0,0,'R');
$pdf->Cell(20,4,number_format($invoice['SSSER'],2),0,0,'R');
$pdf->Cell(18,4,number_format($invoice['SSSEC'],2),0,0,'R');
$pdf->Cell(23,4,number_format($invoice['SSSTotal'],2),0,1,'R');
...
$pdf->Cell(125,7,'SubTotal:    '.number_format($qtot['SSSSum'],2),0,0,'R');
$pdf->Cell(20,7,number_format($qtot['SSSERSum'],2),0,0,'R');
$pdf->Cell(18,7,number_format($qtot['SSSECSum'],2),0,0,'R');
$pdf->Cell(23,7,number_format($qtot['SSSTotalSum'],2),0,1,'R');
}
...
$pdf->Cell(14,4,number_format($qsum['SSSSum'],2),0,0,'R');
$pdf->Cell(20,4,number_format($qsum['SSSERSum'],2),0,0,'R');
$pdf->Cell(18,4,number_format($qsum['SSSECSum'],2),0,0,'R');
$pdf->Cell(23,4,number_format($qsum['SSSTotalSum'],2),0,1,'R');
...
$pdf->SetFont('Arial','B',9);
$pdf->Cell(75,7,'Grand Total:    '.number_format($gran['GSSS'],2),0,0,'R');
$pdf->Cell(20,7,number_format($gran['GSSSER'],2),0,0,'R');
$pdf->Cell(18,7,number_format($gran['GSSSEC'],2),0,0,'R');
$pdf->Cell(23,7,number_format($gran['GSSSTotal'],2),0,1,'R');	
}
$pdf->Cell(0,5,'',0,1,'L');
$pdf->Cell(0,5,'',0,1,'L');
$pdf->SetX(10);
