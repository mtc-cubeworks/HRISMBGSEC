...
$pdf->Cell(17	,7,'GrossPay',0,0,'R');
$pdf->Cell(14	,7,'SSS',0,0,'R');
$pdf->Cell(14	,7,'PHIC',0,0,'R');
$pdf->Cell(14	,7,'PagIbig',0,0,'R');
...
$pdf->Cell(17,4,number_format($invoice['GrossPay'],2),0,0,'R');
$pdf->Cell(14,4,number_format($invoice['SSS'],2),0,0,'R');
$pdf->Cell(14,4,number_format($invoice['PHIC'],2),0,0,'R');
$pdf->Cell(14,4,number_format($invoice['PagIbig'],2),0,0,'R');
$pdf->Cell(17,4,number_format($invoice['NetPay'],2),0,1,'R');
...
$pdf->SetFont('Arial','B',8);
$pdf->Cell(17,5,number_format($qt['TGross'],2),0,0,'R');
$pdf->Cell(14,5,number_format($qt['TSSS'],2),0,0,'R');
$pdf->Cell(14,5,number_format($qt['TPHIC'],2),0,0,'R');
$pdf->Cell(14,5,number_format($qt['TPag'],2),0,0,'R');
$pdf->Cell(17,5,number_format($qt['TNet'],2),0,1,'R');
