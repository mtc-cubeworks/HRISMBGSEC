...
$pdf->Cell(0,5,'PHIC No: '.$qh['EmployerPHICNo'],0,1,'L');
$pdf->SetFont('Arial','',10);
$pdf->Cell(0,5,'Address: '.$qh['EmployerAddress'],0,1,'L');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(0,5,'SUMMARY OF PHILHEALTH CONTRIBUTION',0,1,'L');
$pdf->SetFont('Arial','',10);
...
$pdf->Cell(26,4,$invoice['PhilHealthNo'],0,0,'L');
$pdf->Cell(18,4,number_format($invoice['PHIC'],2),0,0,'R');
$pdf->Cell(20,4,number_format($invoice['PHICER'],2),0,0,'R');
//$pdf->Cell(18,4,number_format($invoice['SSSEC'],2),0,0,'R');
$pdf->Cell(23,4,number_format($invoice['PHICTotal'],2),0,1,'R');
...
$pdf->Cell(125,7,'SubTotal:    '.number_format($qtot['PHICSum'],2),0,0,'R');
$pdf->Cell(20,7,number_format($qtot['PHICERSum'],2),0,0,'R');
//$pdf->Cell(18,7,number_format($qtot['SSSECSum'],2),0,0,'R');
$pdf->Cell(23,7,number_format($qtot['PHICTotalSum'],2),0,1,'R');
}
...
$pdf->Cell(14,4,number_format($qsum['PHICSum'],2),0,0,'R');
$pdf->Cell(20,4,number_format($qsum['PHICERSum'],2),0,0,'R');
//$pdf->Cell(18,4,number_format($qsum['SSSECSum'],2),0,0,'R');
$pdf->Cell(23,4,number_format($qsum['PHICTotalSum'],2),0,1,'R');
...
$pdf->SetFont('Arial','B',9);
$pdf->Cell(75,7,'Grand Total:    '.number_format($gran['GPHIC'],2),0,0,'R');
$pdf->Cell(20,7,number_format($gran['GPHICER'],2),0,0,'R');
//$pdf->Cell(18,7,number_format($gran['GSSSEC'],2),0,0,'R');
$pdf->Cell(23,7,number_format($gran['GPHICTotal'],2),0,1,'R');	
}
$pdf->Cell(0,5,'',0,1,'L');
$pdf->Cell(0,5,'',0,1,'L');
$pdf->SetX(10);
