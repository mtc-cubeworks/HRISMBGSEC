...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "ssstable_print";
...
$page_layouts["ssstable_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "ssstable" );
