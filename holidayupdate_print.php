...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "holidayupdate_print";
...
$page_layouts["holidayupdate_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "holidayupdate" );
