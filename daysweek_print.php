...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "daysweek_print";
...
$page_layouts["daysweek_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "daysweek" );
