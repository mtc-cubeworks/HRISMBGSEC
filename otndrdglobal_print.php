...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "otndrdglobal_print";
...
$page_layouts["otndrdglobal_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "otndrdglobal" );
