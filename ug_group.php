...
$nonAdminTablesArr[] = "payslipposted";
$nonAdminTablesArr[] = "earningsposted";
$nonAdminTablesArr[] = "notes";
$nonAdminTablesArr[] = "notestatus";
$nonAdminTablesArr[] = "notestatuses";
$nonAdminTablesArr[] = "notetypes";
$nonAdminTablesArr[] = "filelogglobal";
$nonAdminTablesArr[] = "mispunched";
$nonAdminTablesArr[] = "Dashboard";
$nonAdminTablesArr[] = "dashrange";
$nonAdminTablesArr[] = "zleavetypes Chart";
$nonAdminTablesArr[] = "zotdept Chart";
$nonAdminTablesArr[] = "zotdiv Chart";
$nonAdminTablesArr[] = "zots";
$nonAdminTablesArr[] = "zots Chart";
$nonAdminTablesArr[] = "zresigns Chart";
$nonAdminTablesArr[] = "attrition Chart";
$nonAdminTablesArr[] = "leavestoday";
$nonAdminTablesArr[] = "latesonrange";
$nonAdminTablesArr[] = "leavesonrange";
$nonAdminTablesArr[] = "absentonrange";
$nonAdminTablesArr[] = "selectemployee";
$nonAdminTablesArr[] = "demo_user11";
$nonAdminTablesArr[] = "demo_useractive";
$nonAdminTablesArr[] = "notes1";
$nonAdminTablesArr[] = "filelogglobal1";
$nonAdminTablesArr[] = "memo";
$nonAdminTablesArr[] = "dtrcard";
$nonAdminTablesArr[] = "dtrcardhead";
$nonAdminTablesArr[] = "dtrcardhead1";
$nonAdminTablesArr[] = "dtrcard1";
$nonAdminTablesArr[] = "payslipmain";
