...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "filelog1_print";
...
$page_layouts["filelog1_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "filelog1" );
