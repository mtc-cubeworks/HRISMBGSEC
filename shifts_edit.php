...
require_once("include/shifts_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "shifts_edit";
...
$page_layouts["shifts_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "shifts_list";
...
$page_layouts["shifts_list"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "addbreaks_list";
$layout->blocks["center"] = array();
$layout->containers["tabs"] = array();
$layout->container_properties["tabs"] = array(  );
$layout->containers["tabs"][] = array("name"=>"bsgrid_tabs",
...
$layout->blocks["topmiddle"][] = "gridcontrols";
$page_layouts["addbreaks_list"] = $layout;
