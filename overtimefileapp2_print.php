...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "overtimefileapp2_print";
...
$page_layouts["overtimefileapp2_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "overtimefileapp2" );
