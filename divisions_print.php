...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "divisions_print";
...
$page_layouts["divisions_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "divisions" );
