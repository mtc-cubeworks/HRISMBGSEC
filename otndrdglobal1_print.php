...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "otndrdglobal1_print";
...
$page_layouts["otndrdglobal1_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "otndrdglobal1" );
