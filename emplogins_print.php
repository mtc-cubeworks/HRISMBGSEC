...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "emplogins_print";
...
$page_layouts["emplogins_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "emplogins" );
