...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "deductypes_print";
...
$page_layouts["deductypes_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "deductypes" );
