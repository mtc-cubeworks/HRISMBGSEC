...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "notes1_print";
...
$page_layouts["notes1_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "notes1" );
