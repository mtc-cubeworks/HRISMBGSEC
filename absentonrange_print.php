...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "absentonrange_print";
...
$page_layouts["absentonrange_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "absentonrange" );
