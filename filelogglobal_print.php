...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "filelogglobal_print";
...
$page_layouts["filelogglobal_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "filelogglobal" );
