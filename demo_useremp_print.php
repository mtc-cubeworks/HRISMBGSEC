...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "demo_useremp_print";
...
$page_layouts["demo_useremp_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "demo_useremp" );
