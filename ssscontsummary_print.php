...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "contlo_masterprint";
...
$page_layouts["contlo_masterprint"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "ssscontsummary" );
