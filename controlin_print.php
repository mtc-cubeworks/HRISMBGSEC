...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "controlin_print";
...
$page_layouts["controlin_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "controlin" );
