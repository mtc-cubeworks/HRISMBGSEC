...
require_once("include/dtrcardhead1_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "dtrcardhead1_print";
...
$page_layouts["dtrcardhead1_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dtrcardhead1" );
