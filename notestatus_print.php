...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "notes_masterprint";
...
$page_layouts["notes_masterprint"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "notestatus" );
