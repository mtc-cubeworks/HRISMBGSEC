...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "filelog_print";
...
$page_layouts["filelog_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "filelog" );
