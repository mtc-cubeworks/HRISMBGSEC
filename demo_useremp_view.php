...
require_once("include/demo_useremp_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "demo_useremp_view";
...
$page_layouts["demo_useremp_view"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "demo_useremp_view_Primary1";
...
$page_layouts["demo_useremp_view_Primary1"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "demo_useremp_view_Leave_Allowance1";
$layout->blocks["bare"] = array();
$layout->containers["tabfields"] = array();
$layout->container_properties["tabfields"] = array(  );
$layout->containers["tabfields"][] = array("name"=>"bsviewtabfields2",
...
$layout->blocks["bare"][] = "tabfields";
$page_layouts["demo_useremp_view_Leave_Allowance1"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "demo_useremp_view_Compensation1";
$layout->blocks["bare"] = array();
$layout->containers["tabfields"] = array();
$layout->container_properties["tabfields"] = array(  );
$layout->containers["tabfields"][] = array("name"=>"bsviewtabfields2",
...
$layout->blocks["bare"][] = "tabfields";
$page_layouts["demo_useremp_view_Compensation1"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "demo_useremp_view_Statutory1";
$layout->blocks["bare"] = array();
$layout->containers["tabfields"] = array();
$layout->container_properties["tabfields"] = array(  );
$layout->containers["tabfields"][] = array("name"=>"bsviewtabfields2",
...
$layout->blocks["bare"][] = "tabfields";
$page_layouts["demo_useremp_view_Statutory1"] = $layout;
