...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "filelogglobal1_print";
...
$page_layouts["filelogglobal1_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "filelogglobal1" );
