...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "schedtype_print";
...
$page_layouts["schedtype_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "schedtype" );
