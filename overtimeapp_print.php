...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "overtimeapp_print";
...
$page_layouts["overtimeapp_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "overtimeapp" );
