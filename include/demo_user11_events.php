<?php
class eventclass_demo_user11  extends eventsBase
{
...
//$asl=DBLookup("select RegularSL from standardsetup where SID=1");
//$avl=DBLookup("select RegularVL from standardsetup where SID=1");
//$ael=DBLookup("select RegularEL from standardsetup where SID=1");
//$apl=DBLookup("select RegularPL from standardsetup where SID=1");

//   $sqs = "Update demo_user set AllowableSickLeave='$asl', AllowableVacationLeave='$avl', AllowableEmergencyLeave='$ael', AllowablePaternityLeave='$apl' where EmployeeID='$eid'";
// CustomQuery($sqs);
