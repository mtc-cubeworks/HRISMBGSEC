...
function InitLookupLinks()
{
	...
	$lookupTableLinks["selectemployee"]["overtimes.SelectEmployees"]["edit"] = array("table" => "overtimes", "field" => "SelectEmployees", "page" => "edit");
	$lookupTableLinks["demo_user"]["overtimetab.EmployeeID"]["edit"] = array("table" => "overtimetab", "field" => "EmployeeID", "page" => "edit");
	...
	$lookupTableLinks["demo_user"]["mispunched.EmployeeID"]["edit"] = array("table" => "mispunched", "field" => "EmployeeID", "page" => "edit");
	$lookupTableLinks["leavetypes"]["leavestoday.LeaveType"]["edit"] = array("table" => "leavestoday", "field" => "LeaveType", "page" => "edit");
	$lookupTableLinks["divisions"]["selectemployee.Division"]["edit"] = array("table" => "selectemployee", "field" => "Division", "page" => "edit");
	$lookupTableLinks["emptype"]["demo_user11.EmployeeType"]["edit"] = array("table" => "demo_user11", "field" => "EmployeeType", "page" => "edit");
	$lookupTableLinks["divisions"]["demo_user11.Division"]["edit"] = array("table" => "demo_user11", "field" => "Division", "page" => "edit");
	$lookupTableLinks["empstatus"]["demo_user11.Status"]["edit"] = array("table" => "demo_user11", "field" => "Status", "page" => "edit");
	$lookupTableLinks["department"]["demo_user11.Department"]["edit"] = array("table" => "demo_user11", "field" => "Department", "page" => "edit");
	$lookupTableLinks["leveldrops"]["demo_user11.Level"]["edit"] = array("table" => "demo_user11", "field" => "Level", "page" => "edit");
	$lookupTableLinks["logins"]["demo_user11.Approvedby"]["edit"] = array("table" => "demo_user11", "field" => "Approvedby", "page" => "edit");
	$lookupTableLinks["logins"]["demo_user11.Preparedby"]["edit"] = array("table" => "demo_user11", "field" => "Preparedby", "page" => "edit");
	$lookupTableLinks["logins"]["demo_user11.Checkedby"]["edit"] = array("table" => "demo_user11", "field" => "Checkedby", "page" => "edit");
	$lookupTableLinks["positions"]["demo_user11.Position"]["edit"] = array("table" => "demo_user11", "field" => "Position", "page" => "edit");
	$lookupTableLinks["demo_user"]["demo_user11.Superior"]["edit"] = array("table" => "demo_user11", "field" => "Superior", "page" => "edit");
	$lookupTableLinks["employername"]["demo_user11.Employer"]["edit"] = array("table" => "demo_user11", "field" => "Employer", "page" => "edit");
	$lookupTableLinks["banks"]["demo_user11.Bank"]["edit"] = array("table" => "demo_user11", "field" => "Bank", "page" => "edit");
	$lookupTableLinks["demo_user"]["demo_user11.Superior2"]["edit"] = array("table" => "demo_user11", "field" => "Superior2", "page" => "edit");
	$lookupTableLinks["emptype"]["demo_useractive.EmployeeType"]["edit"] = array("table" => "demo_useractive", "field" => "EmployeeType", "page" => "edit");
	$lookupTableLinks["divisions"]["demo_useractive.Division"]["edit"] = array("table" => "demo_useractive", "field" => "Division", "page" => "edit");
	$lookupTableLinks["empstatus"]["demo_useractive.Status"]["edit"] = array("table" => "demo_useractive", "field" => "Status", "page" => "edit");
	$lookupTableLinks["department"]["demo_useractive.Department"]["edit"] = array("table" => "demo_useractive", "field" => "Department", "page" => "edit");
	$lookupTableLinks["leveldrops"]["demo_useractive.Level"]["edit"] = array("table" => "demo_useractive", "field" => "Level", "page" => "edit");
	$lookupTableLinks["logins"]["demo_useractive.Approvedby"]["edit"] = array("table" => "demo_useractive", "field" => "Approvedby", "page" => "edit");
	$lookupTableLinks["logins"]["demo_useractive.Preparedby"]["edit"] = array("table" => "demo_useractive", "field" => "Preparedby", "page" => "edit");
	$lookupTableLinks["logins"]["demo_useractive.Checkedby"]["edit"] = array("table" => "demo_useractive", "field" => "Checkedby", "page" => "edit");
	$lookupTableLinks["demo_user"]["demo_useractive.Superior"]["edit"] = array("table" => "demo_useractive", "field" => "Superior", "page" => "edit");
	$lookupTableLinks["positions"]["demo_useractive.Position"]["edit"] = array("table" => "demo_useractive", "field" => "Position", "page" => "edit");
	$lookupTableLinks["employername"]["demo_useractive.Employer"]["edit"] = array("table" => "demo_useractive", "field" => "Employer", "page" => "edit");
	$lookupTableLinks["banks"]["demo_useractive.Bank"]["edit"] = array("table" => "demo_useractive", "field" => "Bank", "page" => "edit");
	$lookupTableLinks["demo_user"]["demo_useractive.Superior2"]["edit"] = array("table" => "demo_useractive", "field" => "Superior2", "page" => "edit");
	$lookupTableLinks["notetypes"]["notes1.NoteType"]["edit"] = array("table" => "notes1", "field" => "NoteType", "page" => "edit");
	$lookupTableLinks["logins"]["notes1.Encodedby"]["edit"] = array("table" => "notes1", "field" => "Encodedby", "page" => "edit");
	$lookupTableLinks["demo_user"]["notes1.EmployeeID"]["edit"] = array("table" => "notes1", "field" => "EmployeeID", "page" => "edit");
	$lookupTableLinks["notestatuses"]["notes1.Status"]["edit"] = array("table" => "notes1", "field" => "Status", "page" => "edit");
	$lookupTableLinks["demo_user"]["filelogglobal1.Employee"]["edit"] = array("table" => "filelogglobal1", "field" => "Employee", "page" => "edit");
	$lookupTableLinks["logins"]["memo.PreparedBy"]["edit"] = array("table" => "memo", "field" => "PreparedBy", "page" => "edit");
	$lookupTableLinks["demo_user"]["dtrcard.EmployeeID"]["edit"] = array("table" => "dtrcard", "field" => "EmployeeID", "page" => "edit");
	$lookupTableLinks["daysweek"]["dtrcard.DayIs"]["edit"] = array("table" => "dtrcard", "field" => "DayIs", "page" => "edit");
	$lookupTableLinks["holidaytype"]["dtrcard.HolidayType"]["edit"] = array("table" => "dtrcard", "field" => "HolidayType", "page" => "edit");
	$lookupTableLinks["employername"]["dtrcardhead.Employer"]["edit"] = array("table" => "dtrcardhead", "field" => "Employer", "page" => "edit");
	$lookupTableLinks["divisions"]["dtrcardhead.Division"]["edit"] = array("table" => "dtrcardhead", "field" => "Division", "page" => "edit");
	$lookupTableLinks["department"]["dtrcardhead.Department"]["edit"] = array("table" => "dtrcardhead", "field" => "Department", "page" => "edit");
	$lookupTableLinks["employername"]["dtrcardhead1.Employer"]["edit"] = array("table" => "dtrcardhead1", "field" => "Employer", "page" => "edit");
	$lookupTableLinks["divisions"]["dtrcardhead1.Division"]["edit"] = array("table" => "dtrcardhead1", "field" => "Division", "page" => "edit");
	$lookupTableLinks["department"]["dtrcardhead1.Department"]["edit"] = array("table" => "dtrcardhead1", "field" => "Department", "page" => "edit");
	$lookupTableLinks["demo_user"]["dtrcard1.EmployeeID"]["edit"] = array("table" => "dtrcard1", "field" => "EmployeeID", "page" => "edit");
	$lookupTableLinks["daysweek"]["dtrcard1.DayIs"]["edit"] = array("table" => "dtrcard1", "field" => "DayIs", "page" => "edit");
	$lookupTableLinks["holidaytype"]["dtrcard1.HolidayType"]["edit"] = array("table" => "dtrcard1", "field" => "HolidayType", "page" => "edit");
}
