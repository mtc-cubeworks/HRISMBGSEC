...
function checkTableName($shortTName, $type=false)
{
	...
	if ("demo_device" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("demo_user" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("demo_finger" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("demo_log" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("holidays" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("standardsetup" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("schedrange" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("schedtab" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("indschedule" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("schedtype" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("holidaytype" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("emptype" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("leavetypes" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("logins" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	...
	if ("admin_users" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("loans" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("divisions" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("department" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("empstatus" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("payroll" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("payrolltab" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ssstable" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("philhealthtable" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("loantypes" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("loandesriptions" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("earningadjustment" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("adjustmentdescriptions" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("adjtypes" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("payrollearnadj" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("payrolldeductions" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("paymentperiods" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("daysweek" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("shifts" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("dtrrange" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("indleave" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("ileave" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("daylength" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("leavebalance" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("indschedule1" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("controlin" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("dt5" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("indovertime" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("forapp" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("payrollstatutories" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("payrolltax" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("payrollamt3" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("empdeminimis" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("emplevels" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("demo_user1" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("leveldrops" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("latepenalty" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("nightshiftallowance" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("emphistory" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("modulelock" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("moduletable" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("dloglimit2" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("indschedule11" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("positions" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("employername" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pagibigtable" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pprint" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("statutorylock" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	...
	if ("leaves1" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("ssscontsummary" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("leaves11" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("leavesapp" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("leavebalance1" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("indleave1" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("loansreport" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("contlo" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("statpay" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	...
	if ("monthlyremittax" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("withholdingcat" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("banks" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("empdtr" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("emplogins" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("removedata" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("schedby" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("overtimes" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("overtimetab" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	...
	if ("indovertime1" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("payrolldiv" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("logo" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("addbreaks" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("indbreaks" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("dtrtable" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	...
	if ("approvalbutton" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("otherpayments" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("payrolltab1" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("mycurrentdtr" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("otndrdglobal" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("dtrrange1" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("dtrempl" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("otndrdglobal1" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("deductypes" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("magroups" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("mdgroups" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("loanbalnew5" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
...
{
	$arr = array();
	$strPerm = GetUserPermissions("demo_device");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="demo_device";
	}
	$strPerm = GetUserPermissions("demo_user");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="demo_user";
	}
	$strPerm = GetUserPermissions("demo_finger");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="demo_finger";
	}
	$strPerm = GetUserPermissions("demo_log");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="demo_log";
	}
	$strPerm = GetUserPermissions("holidays");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="holidays";
	}
	$strPerm = GetUserPermissions("standardsetup");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="standardsetup";
	}
	$strPerm = GetUserPermissions("schedrange");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="schedrange";
	}
	$strPerm = GetUserPermissions("schedtab");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="schedtab";
	}
	$strPerm = GetUserPermissions("indschedule");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="indschedule";
	}
	$strPerm = GetUserPermissions("schedtype");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="schedtype";
	}
	$strPerm = GetUserPermissions("holidaytype");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="holidaytype";
	}
	$strPerm = GetUserPermissions("emptype");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="emptype";
	}
	$strPerm = GetUserPermissions("leavetypes");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="leavetypes";
	}
	$strPerm = GetUserPermissions("logins");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="logins";
	}
	...
	$strPerm = GetUserPermissions("loans");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="loans";
	}
	$strPerm = GetUserPermissions("divisions");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="divisions";
	}
	...
	$strPerm = GetUserPermissions("empstatus");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="empstatus";
	}
	...
	$strPerm = GetUserPermissions("payrolltab");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="payrolltab";
	}
	$strPerm = GetUserPermissions("ssstable");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ssstable";
	}
	$strPerm = GetUserPermissions("philhealthtable");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="philhealthtable";
	}
	$strPerm = GetUserPermissions("loantypes");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="loantypes";
	}
	$strPerm = GetUserPermissions("loandesriptions");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="loandesriptions";
	}
	$strPerm = GetUserPermissions("earningadjustment");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="earningadjustment";
	}
	$strPerm = GetUserPermissions("adjustmentdescriptions");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="adjustmentdescriptions";
	}
	$strPerm = GetUserPermissions("adjtypes");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="adjtypes";
	}
	$strPerm = GetUserPermissions("payrollearnadj");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="payrollearnadj";
	}
	$strPerm = GetUserPermissions("payrolldeductions");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="payrolldeductions";
	}
	$strPerm = GetUserPermissions("paymentperiods");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="paymentperiods";
	}
	$strPerm = GetUserPermissions("daysweek");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="daysweek";
	}
	$strPerm = GetUserPermissions("shifts");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="shifts";
	}
	$strPerm = GetUserPermissions("dtrrange");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dtrrange";
	}
	$strPerm = GetUserPermissions("indleave");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="indleave";
	}
	$strPerm = GetUserPermissions("ileave");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ileave";
	}
	$strPerm = GetUserPermissions("daylength");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="daylength";
	}
	$strPerm = GetUserPermissions("leavebalance");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="leavebalance";
	}
	$strPerm = GetUserPermissions("indschedule1");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="indschedule1";
	}
	$strPerm = GetUserPermissions("controlin");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="controlin";
	}
	$strPerm = GetUserPermissions("dt5");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dt5";
	}
	$strPerm = GetUserPermissions("indovertime");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="indovertime";
	}
	$strPerm = GetUserPermissions("forapp");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="forapp";
	}
	$strPerm = GetUserPermissions("payrollstatutories");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="payrollstatutories";
	}
	$strPerm = GetUserPermissions("payrolltax");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="payrolltax";
	}
	$strPerm = GetUserPermissions("payrollamt3");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="payrollamt3";
	}
	$strPerm = GetUserPermissions("empdeminimis");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="empdeminimis";
	}
	$strPerm = GetUserPermissions("emplevels");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="emplevels";
	}
	$strPerm = GetUserPermissions("demo_user1");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="demo_user1";
	}
	$strPerm = GetUserPermissions("leveldrops");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="leveldrops";
	}
	$strPerm = GetUserPermissions("latepenalty");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="latepenalty";
	}
	$strPerm = GetUserPermissions("nightshiftallowance");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="nightshiftallowance";
	}
	$strPerm = GetUserPermissions("emphistory");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="emphistory";
	}
	$strPerm = GetUserPermissions("modulelock");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="modulelock";
	}
	$strPerm = GetUserPermissions("moduletable");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="moduletable";
	}
	$strPerm = GetUserPermissions("dloglimit2");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dloglimit2";
	}
	$strPerm = GetUserPermissions("indschedule11");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="indschedule11";
	}
	$strPerm = GetUserPermissions("positions");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="positions";
	}
	$strPerm = GetUserPermissions("employername");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="employername";
	}
	$strPerm = GetUserPermissions("pagibigtable");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="pagibigtable";
	}
	$strPerm = GetUserPermissions("pprint");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="pprint";
	}
	$strPerm = GetUserPermissions("statutorylock");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="statutorylock";
	}
	$strPerm = GetUserPermissions("payroll21");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="payroll21";
	}
	...
	$strPerm = GetUserPermissions("leaves1");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="leaves1";
	}
	$strPerm = GetUserPermissions("ssscontsummary");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="ssscontsummary";
	}
	$strPerm = GetUserPermissions("leaves11");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="leaves11";
	}
	$strPerm = GetUserPermissions("leavesapp");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="leavesapp";
	}
	$strPerm = GetUserPermissions("leavebalance1");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="leavebalance1";
	}
	$strPerm = GetUserPermissions("indleave1");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="indleave1";
	}
	...
	$strPerm = GetUserPermissions("contlo");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="contlo";
	}
	$strPerm = GetUserPermissions("statpay");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="statpay";
	}
	$strPerm = GetUserPermissions("annualtaxtab");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="annualtaxtab";
	}
	...
	$strPerm = GetUserPermissions("monthlyremittax");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="monthlyremittax";
	}
	$strPerm = GetUserPermissions("withholdingcat");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="withholdingcat";
	}
	$strPerm = GetUserPermissions("banks");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="banks";
	}
	$strPerm = GetUserPermissions("empdtr");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="empdtr";
	}
	$strPerm = GetUserPermissions("emplogins");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="emplogins";
	}
	$strPerm = GetUserPermissions("removedata");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="removedata";
	}
	$strPerm = GetUserPermissions("schedby");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="schedby";
	}
	$strPerm = GetUserPermissions("overtimes");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="overtimes";
	}
	$strPerm = GetUserPermissions("overtimetab");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="overtimetab";
	}
	$strPerm = GetUserPermissions("overtimefile");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="overtimefile";
	}
	...
	$strPerm = GetUserPermissions("indovertime1");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="indovertime1";
	}
	$strPerm = GetUserPermissions("payrolldiv");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="payrolldiv";
	}
	$strPerm = GetUserPermissions("logo");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="logo";
	}
	$strPerm = GetUserPermissions("addbreaks");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="addbreaks";
	}
	$strPerm = GetUserPermissions("indbreaks");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="indbreaks";
	}
	$strPerm = GetUserPermissions("dtrtable");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dtrtable";
	}
	$strPerm = GetUserPermissions("periods");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="periods";
	}
	$strPerm = GetUserPermissions("clocktypes");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="clocktypes";
	}
	...
	$strPerm = GetUserPermissions("otherpayments");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="otherpayments";
	}
	...
	$strPerm = GetUserPermissions("mycurrentdtr");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="mycurrentdtr";
	}
	$strPerm = GetUserPermissions("otndrdglobal");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="otndrdglobal";
	}
	$strPerm = GetUserPermissions("dtrrange1");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dtrrange1";
	}
	$strPerm = GetUserPermissions("dtrempl");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="dtrempl";
	}
	$strPerm = GetUserPermissions("otndrdglobal1");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="otndrdglobal1";
	}
	$strPerm = GetUserPermissions("deductypes");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="deductypes";
	}
	$strPerm = GetUserPermissions("magroups");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="magroups";
	}
	$strPerm = GetUserPermissions("mdgroups");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="mdgroups";
	}
	$strPerm = GetUserPermissions("loanbalnew5");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="loanbalnew5";
	}
	$strPerm = GetUserPermissions("loanbalnew51");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="loanbalnew51";
	}
...
function ReadUserPermissions($userID = "")
{
	...
	if($userID != "Guest")
	{
		...
		$sql = "select ".$gConn->addFieldWrappers( "GroupID" )
			...
			." from ". $gConn->addTableWrappers( "payrollflex1_ugmembers" )
	...
	$sql = "select ". $gConn->addFieldWrappers( "TableName" )
		...
		." from ". $gConn->addTableWrappers( "payrollflex1_ugrights" )
...
function AfterFBLogIn( $pUsername, $pPassword, $pDisplayUsername, &$pageObject = null)
{
	...
	$strSQL = "select * from ".$connection->addTableWrappers("logins")
...
function SetAuthSessionData($pUsername, &$data, $fromFacebook, $password, &$pageObject = null, $fireEvents = true )
{
	...
	$_SESSION["GroupID"] = $data["UserName"];
		...
		$_SESSION["OwnerID"] = $data["LogID"];
	$_SESSION["_ssscontsummary_OwnerID"] = $data["LogID"];
		$_SESSION["_leaves11_OwnerID"] = $data["EmployeeID"];
		$_SESSION["_leavesapp_OwnerID"] = $data["EmployeeID"];
...
function getLatLngByAddr($addr)
{
	...
	switch( getMapProvider() ){
		case GOOGLE_MAPS:	$url = 'http://maps.googleapis.com/maps/api/geocode/json?address='.rawurlencode($addr).'&sensor=false&key=' . $globalSettings["apiGoogleMapsCode"];
