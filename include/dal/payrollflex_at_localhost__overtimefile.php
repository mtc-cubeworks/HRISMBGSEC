...
$dalTableovertimefile["Posted"] = array("type"=>16,"varname"=>"Posted", "name" => "Posted");
$dalTableovertimefile["NoMins"] = array("type"=>5,"varname"=>"NoMins", "name" => "NoMins");
$dalTableovertimefile["ApprovedDate"] = array("type"=>7,"varname"=>"ApprovedDate", "name" => "ApprovedDate");
$dalTableovertimefile["EmployeeID"] = array("type"=>3,"varname"=>"EmployeeID", "name" => "EmployeeID");
