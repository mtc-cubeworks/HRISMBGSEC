...
$value=NULL;;
				...
				if($table=="logins" && $field=="Password")
	{
		...
		return $value;
				...
				if($table=="emplogins" && $field=="Password")
	{
		$value = '********';
		return $value;
	}
				if($table=="indscheduleemp" && $field=="RegWD")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="DWork")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="Absent")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="LateMins")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="UndertimeMins")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="RHolidayHrs")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="SHolidayHrs")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="ExcessHrs")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="RegOTHrs")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="RHOTHrs")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="SHOTHrs")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="RDOTHrs")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="RHNDHrs")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="SHNDHrs")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="RDNDHrs")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="VLDay")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="SLDay")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="ELDay")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="PLDay")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="TrODay")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="TotLateMins")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="LatePenaltyMins")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="LateFixPenalty")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="BreakLateMins")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="RHNDOTHrs")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="SHNDOTHrs")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="RDNDOTHrs")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="DH")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="DHRD")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="DHOT")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="DHRDOT")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="SHRDND")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="RHRDND")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="SHRDNDOT")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="RHRDNDOT")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="DHND")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="DHRDND")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="DHNDOT")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="DHRDNDOT")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="RHRDOT")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="SHRDOT")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="RegND")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="RegRD")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="SHOTD")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="SHRDOTD")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="NDOT")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="RHRD")
	{
		if ($value>0)
$value=$value;
else
$value=NULL;;
		return $value;
				...
				if($table=="indscheduleemp" && $field=="SHRD")
	{
		if ($value>0)
$value=$value;
else
...
function GetDefaultValue($field, $ptype, $table="")
{
	...
	if(!$table)
		$table=$strTableName;
				if($table=="demo_user" && $field=="AllowableSickLeave")
	{
		return 0;
	}
				if($table=="demo_user" && $field=="AllowableVacationLeave")
	{
		return 0;
	}
				if($table=="demo_user" && $field=="AllowableEmergencyLeave")
	{
		return 0;
	}
				if($table=="demo_user" && $field=="AllowablePaternityLeave")
	{
		return 0;
	}
				if($table=="demo_user" && $field=="DateCreated")
	{
		return now();
	}
				if($table=="demo_log" && $field=="data")
	{
		return "Manual Entry";
	}
				if($table=="demo_log" && $field=="MLogID")
	{
				...
				if($table=="indovertime" && $field=="DateCreated")
	{
		return now();
				...
				if($table=="demo_user1" && $field=="BasicMonthlyPay")
	{
		return 0;
	}
				if($table=="demo_user1" && $field=="BasicDailyPay")
	{
		return 0;
	}
				if($table=="demo_user1" && $field=="DateCreated")
	{
		return now();
	}
				if($table=="demo_user1" && $field=="DeMinimis")
	{
		return 0;
	}
				if($table=="leaves1" && $field=="DateCreated")
	{
		return now();
	}
				if($table=="ssscontsummary" && $field=="PreparedBy")
	{
		return Security::getOwnerId($table);
	}
				if($table=="leaves11" && $field=="DateCreated")
	{
		return now();
	}
				if($table=="leavesapp" && $field=="DateCreated")
	{
		return now();
	}
				if($table=="loansreport" && $field=="PreparedBy")
	{
		return Security::getOwnerId($table);
	}
				if($table=="monthlyremittax" && $field=="AmendedReturn")
	{
		return 0;
	}
				if($table=="monthlyremittax" && $field=="AnyTaxWithheld")
	{
		return 1;
	}
				if($table=="monthlyremittax" && $field=="AwaitingTaxRelief")
	{
		return 0;
	}
				if($table=="overtimes" && $field=="DateCreated")
	{
		return now();
	}
				if($table=="overtimefile" && $field=="DateCreated")
	{
		return now();
	}
