<?php
class eventclass_leavesapp2  extends eventsBase
{
...
//$at10 = $xt->fetchVar("1stApproval_editcontrol");
//$at10 = str_replace(">"," DISABLED=DISABLED>",$at10);
//$xt->assign("1stApproval_editcontrol",$at10);
...
$mgrname=DBLookup("SELECT user_name FROM demo_user WHERE EmployeeID='$su2'");
