...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "dt5_masterlist";
...
$page_layouts["dt5_masterlist"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "indschedule_masterlist";
$layout->blocks["bare"] = array();
$layout->containers["column"] = array();
$layout->container_properties["column"] = array(  );
$layout->containers["column"][] = array("name"=>"masterlistheader",
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["indschedule_masterlist"] = $layout;
