...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "adjustmentdescriptions_print";
...
$page_layouts["adjustmentdescriptions_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "adjustmentdescriptions" );
