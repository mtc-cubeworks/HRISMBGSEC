...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "overtimefileapp_print";
...
$page_layouts["overtimefileapp_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "overtimefileapp" );
