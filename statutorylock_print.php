...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "statutorylock_print";
...
$page_layouts["statutorylock_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "statutorylock" );
