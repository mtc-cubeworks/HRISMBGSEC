...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "nightshiftallowance_print";
...
$page_layouts["nightshiftallowance_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "nightshiftallowance" );
