...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "leaves_print";
...
$page_layouts["leaves_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "leaves" );
