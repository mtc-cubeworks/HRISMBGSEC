...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "schedby_print";
...
$page_layouts["schedby_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "schedby" );
