...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "department_print";
...
$page_layouts["department_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "department" );
