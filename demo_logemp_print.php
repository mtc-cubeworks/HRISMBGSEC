...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "demo_logemp_print";
...
$page_layouts["demo_logemp_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "demo_logemp" );
