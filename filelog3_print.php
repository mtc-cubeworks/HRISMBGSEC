...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "filelog3_print";
...
$page_layouts["filelog3_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "filelog3" );
