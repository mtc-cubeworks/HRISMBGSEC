...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("demo_device" == $this->chrt_array['tables'][0])
			return true;
		if("demo_user" == $this->chrt_array['tables'][0])
			return true;
		if("demo_finger" == $this->chrt_array['tables'][0])
			return true;
		if("demo_log" == $this->chrt_array['tables'][0])
			return true;
		if("holidays" == $this->chrt_array['tables'][0])
			return true;
		if("standardsetup" == $this->chrt_array['tables'][0])
			return true;
		if("schedrange" == $this->chrt_array['tables'][0])
			return true;
		if("schedtab" == $this->chrt_array['tables'][0])
			return true;
		if("indschedule" == $this->chrt_array['tables'][0])
			return true;
		if("schedtype" == $this->chrt_array['tables'][0])
			return true;
		if("holidaytype" == $this->chrt_array['tables'][0])
			return true;
		if("emptype" == $this->chrt_array['tables'][0])
			return true;
		if("leavetypes" == $this->chrt_array['tables'][0])
			return true;
		if("logins" == $this->chrt_array['tables'][0])
			return true;
		if("payrollflex1_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("logins" == $this->chrt_array['tables'][0])
			return true;
		if("logins" == $this->chrt_array['tables'][0])
			return true;
		if("loans" == $this->chrt_array['tables'][0])
			return true;
		if("divisions" == $this->chrt_array['tables'][0])
			return true;
		if("department" == $this->chrt_array['tables'][0])
			return true;
		if("empstatus" == $this->chrt_array['tables'][0])
			return true;
		if("payroll" == $this->chrt_array['tables'][0])
			return true;
		if("payrolltab" == $this->chrt_array['tables'][0])
			return true;
		if("ssstable" == $this->chrt_array['tables'][0])
			return true;
		if("philhealthtable" == $this->chrt_array['tables'][0])
			return true;
		if("loantypes" == $this->chrt_array['tables'][0])
			return true;
		if("loandesriptions" == $this->chrt_array['tables'][0])
			return true;
		if("earningadjustment" == $this->chrt_array['tables'][0])
			return true;
		if("adjustmentdescriptions" == $this->chrt_array['tables'][0])
			return true;
		if("adjtypes" == $this->chrt_array['tables'][0])
			return true;
		if("payrollearnadj" == $this->chrt_array['tables'][0])
			return true;
		if("payrolldeductions" == $this->chrt_array['tables'][0])
			return true;
		if("paymentperiods" == $this->chrt_array['tables'][0])
			return true;
		if("daysweek" == $this->chrt_array['tables'][0])
			return true;
		if("shifts" == $this->chrt_array['tables'][0])
			return true;
		if("dtrrange" == $this->chrt_array['tables'][0])
			return true;
		if("indleave" == $this->chrt_array['tables'][0])
			return true;
		if("ileave" == $this->chrt_array['tables'][0])
			return true;
		if("daylength" == $this->chrt_array['tables'][0])
			return true;
		if("leavebalance" == $this->chrt_array['tables'][0])
			return true;
		if("indschedule" == $this->chrt_array['tables'][0])
			return true;
		if("controlin" == $this->chrt_array['tables'][0])
			return true;
		if("dt5" == $this->chrt_array['tables'][0])
			return true;
		if("indovertime" == $this->chrt_array['tables'][0])
			return true;
		if("forapp" == $this->chrt_array['tables'][0])
			return true;
		...
		if("payrollamt3" == $this->chrt_array['tables'][0])
			return true;
		if("empdeminimis" == $this->chrt_array['tables'][0])
			return true;
		if("emplevels" == $this->chrt_array['tables'][0])
			return true;
		if("demo_user" == $this->chrt_array['tables'][0])
			return true;
		if("leveldrops" == $this->chrt_array['tables'][0])
			return true;
		if("latepenalty" == $this->chrt_array['tables'][0])
			return true;
		if("nightshiftallowance" == $this->chrt_array['tables'][0])
			return true;
		if("emphistory" == $this->chrt_array['tables'][0])
			return true;
		if("modulelock" == $this->chrt_array['tables'][0])
			return true;
		if("moduletable" == $this->chrt_array['tables'][0])
			return true;
		if("dloglimit2" == $this->chrt_array['tables'][0])
			return true;
		if("indschedule" == $this->chrt_array['tables'][0])
			return true;
		if("positions" == $this->chrt_array['tables'][0])
			return true;
		if("employername" == $this->chrt_array['tables'][0])
			return true;
		if("pagibigtable" == $this->chrt_array['tables'][0])
			return true;
		if("pprint" == $this->chrt_array['tables'][0])
			return true;
		if("statutorylock" == $this->chrt_array['tables'][0])
			return true;
		if("payroll" == $this->chrt_array['tables'][0])
			return true;
		...
		if("leaves" == $this->chrt_array['tables'][0])
			return true;
		if("ssscontsummary" == $this->chrt_array['tables'][0])
			return true;
		if("leaves" == $this->chrt_array['tables'][0])
			return true;
		if("leaves" == $this->chrt_array['tables'][0])
		...
		if("loansreport" == $this->chrt_array['tables'][0])
			return true;
		if("contlo" == $this->chrt_array['tables'][0])
			return true;
		if("statpay" == $this->chrt_array['tables'][0])
			return true;
		...
		if("monthlyremittax" == $this->chrt_array['tables'][0])
			return true;
		if("withholdingcat" == $this->chrt_array['tables'][0])
			return true;
		if("banks" == $this->chrt_array['tables'][0])
			return true;
		if("indschedule" == $this->chrt_array['tables'][0])
			return true;
		if("logins" == $this->chrt_array['tables'][0])
			return true;
		if("removedata" == $this->chrt_array['tables'][0])
			return true;
		if("schedby" == $this->chrt_array['tables'][0])
			return true;
		if("overtimes" == $this->chrt_array['tables'][0])
			return true;
		if("overtimetab" == $this->chrt_array['tables'][0])
			return true;
		...
		if("indovertime" == $this->chrt_array['tables'][0])
			return true;
		if("payrolldiv" == $this->chrt_array['tables'][0])
			return true;
		if("logo" == $this->chrt_array['tables'][0])
			return true;
		if("addbreaks" == $this->chrt_array['tables'][0])
			return true;
		if("indbreaks" == $this->chrt_array['tables'][0])
			return true;
		if("dtrtable" == $this->chrt_array['tables'][0])
			return true;
