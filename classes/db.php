...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "payrollflex_at_localhost" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "holidaygroups", "varname" => "payrollflex_at_localhost__holidaygroups", "altvarname" => "holidaygroups", "connId" => "payrollflex_at_localhost", "schema" => "", "connName" => "payrollg at localhost");
