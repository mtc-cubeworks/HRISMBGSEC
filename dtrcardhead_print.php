...
require_once("include/dtrcardhead_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "default";
		$layout->customCssPageName = "dtrcardhead_print";
...
$page_layouts["dtrcardhead_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dtrcardhead" );
